...
class AddUser:
    def __init__(self,root):
        ...
        role_combo['values'] = ('Select role','Administrator','Sale Person')
        ...
        self.userTable.column("firstname", width=100,anchor='n')
        self.userTable.column("lastname", width=100,anchor='n')
        self.userTable.column("phone", width=100,anchor='n')
        self.userTable.column("password", width=100, anchor='n')
        self.userTable.column("role", width=100,anchor='n')
