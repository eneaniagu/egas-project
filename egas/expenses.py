...
class Expenses:
    def __init__(self,root):
        ...
        self.txt_costprice = Entry(self.manager_frame, textvariable=self.description, font=("times new roman", 14, "bold"), bd=2, relief=RIDGE)
        self.txt_costprice.grid(row=2, column=1, pady=10, padx=20, sticky='w')
        ...
        self.txt_saleprice = Entry(self.manager_frame,textvariable=self.amount, font=("times new roman", 14, "bold"), bd=2, relief=RIDGE)
        self.txt_saleprice.grid(row=3, column=1, pady=10, padx=20, sticky='w')
